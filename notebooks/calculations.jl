...
# ╔═╡ 62b19864-244b-11f1-a479-c566cd616e86
begin
	using Symbolics
	import Latexify
end

# ╔═╡ 4c11b60d-762d-46c5-b26e-db4de6a9a874
# Panel's angles
@variables β, ᾱ, ρ # tilt, azimuth, roll

# ╔═╡ 32adbce5-1dbf-4b5e-8781-ec463f42fe29
# Solar position angles
@variables η, α # elevation, azimuth

# ╔═╡ 262dff85-06cd-4e9d-b527-07db2883e29c
# Rotation matrices
# - tilt: clockwise rotation around the West-East (1st) axis
# - roll: clockwise rotation around the South-North (2nd) axis
# - azimuth: clockwise rotation around the UP (3rd) axis
begin
	rot_matrix_west_east(β) = [
		1 0       0     
		0 cos(β) -sin(β)
		0 sin(β)  cos(β) 
	]
...
# ╔═╡ f000f89c-793a-4e3a-9a8c-21874331732b
begin
	# Panel normal vector
	e₃ = [0, 0, 1]
	panel_normal = rot_matrix_up(ᾱ)' * 
				   rot_matrix_south_north(0) *
				   rot_matrix_west_east(β)' *
				   e₃
end

# ╔═╡ bbcb837b-8deb-43af-a184-83e67faa6d23
begin
	# Sun ray direction, from observer towards Sun 
	e₂ = [0, 1, 0]
	sunray = rot_matrix_up(α)' * rot_matrix_west_east(η) * e₂
end

# ╔═╡ 2f6fc275-8fa2-4280-97a7-ba5aac987ea9
begin
	# Angle of incidence projection
	aoi_projection = panel_normal' * sunray
	simplify(aoi_projection)
end

# ╔═╡ 089f6d19-211a-447c-a122-1406a9ed1709


# ╔═╡ af46830b-827f-4fbd-b54a-80f18769cd05
...
manifest_format = "2.0"
project_hash = "4e8a337855a93e13765e7aaccc8509fe8c6b4fbf"
...
git-tree-sha1 = "0a3bbbf97e7204e93b3a9f4c392d2df41069c3ed"
